...
# Olá, chamo-me Emanoell.
Atualmente estou estudando na Faculdade de Tecnologia de Lins - Fatec, no curso de Análise e Desenvolvimento de Sistemas (ADS). Minha paixão pela programação surgiu quando era criança mexendo no meu primeiro computador, desde então nunca mais consegui largá-lo.

Hoje possuo conhecimento em várias tecnologias:
